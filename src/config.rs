...
pub const RENDEZVOUS_SERVERS: &[&str] = &["172.16.207.240","166.108.233.243"];
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["172.16.207.240"];
pub const RS_PUB_KEY: &str = "gxzjy_wwz_shishen";
...
>>>>>>> b7d75348fda87cc07efc10bd1e41f195f0b05393
